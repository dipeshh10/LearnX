...
import { GraduationCap, Mail, Lock, User, AlertCircle, Github } from 'lucide-react';
...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created!', 'Welcome to LearnX. Please verify your email.');
      navigate('/dashboard');
    } catch (err) {
  ...
  const handleSocialSignup = (provider: string) => {
    toast.info('Coming soon', `${provider} signup will be available soon.`);
  };
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Join LearnX and start your learning journey today
            </p>
          </motion.div>
          ...
          <div className="max-w-lg text-center">
            ...
            <div className="text-white">
              ...
              <p className="text-xl text-blue-100">
                Connect with thousands of learners and instructors worldwide. Expand your knowledge and advance your career.
              </p>
            </div>
          </div>
        </div>
